<?php /*a:3:{s:73:"D:\phpstudy_pro\WWW\127.0.0.3\cjt\application\admin\view\order\index.html";i:1559288000;s:74:"D:\phpstudy_pro\WWW\127.0.0.3\cjt\application\admin\view\public\_meta.html";i:1530329594;s:76:"D:\phpstudy_pro\WWW\127.0.0.3\cjt\application\admin\view\public\_footer.html";i:1530790558;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<tbody>
			<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<tr class="text-c">
					...
					<td><?php if($vo['or_status'] == 5): ?>
						<a href="javascript:;" onclick="approval(<?php echo htmlentities($vo['id']); ?>,<?php echo htmlentities($vo['us_id']); ?>)" class="c-red">[审核]</a> 
					<?php else: ?> 无需审核<?php endif; ?>
					</td>
					<td><?php echo htmlentities($vo['pay_type_text']); ?></td>										
...
function excellist(){
    ...
    var url = "<?php echo url('excellist'); ?>?status="+ss+"&start="+start+"&end="+end+"&ornum="+ornum;
     //alert(end);
...
function approval(id,uid){
	var url ="<?php echo url('Order/Approval'); ?>?id="+id+"&&uid="+uid;
