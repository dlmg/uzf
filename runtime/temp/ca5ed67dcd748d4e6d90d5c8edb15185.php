<?php /*a:1:{s:59:"D:\phpStudy\WWW\szsc\application\index\view\cart\index.html";i:1534242225;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
			...
			<ul>
				...
				<li>
					...
					<div class="li_wz">
						...
						<label for="">
							￥<p id="time"><?php echo htmlentities($vo['pd_price']); ?></p>&nbsp;&nbsp;<span><?php echo htmlentities($vo['pd_sales']); ?>人付款</span>&nbsp;&nbsp;&nbsp;&nbsp;	
							<span>运费：<?php echo htmlentities($vo['take_fee']); ?></span>						
						</label>
						<time></time>	
						<ul>
							<li><input type="button" onclick="cutnum(<?php echo htmlentities($vo['id']); ?>)" value="-"></li>
							<li><input type="text" id="txt" value="<?php echo htmlentities($vo['pd_num']); ?>"/></li>
