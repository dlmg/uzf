<?php /*a:3:{s:64:"D:\phpstudy_pro\WWW\uzf\application\admin\view\product\last.html";i:1585807367;s:64:"D:\phpstudy_pro\WWW\uzf\application\admin\view\public\_meta.html";i:1530329594;s:66:"D:\phpstudy_pro\WWW\uzf\application\admin\view\public\_footer.html";i:1530790558;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			<a href="javascript:;" onclick="create(<?php echo htmlentities($ca_id); ?>,'last_add','添加时间段')" class="btn btn-primary radius">
...
<!--                <td><?php echo htmlentities($vo['id']); ?></td>-->
                <td><?php echo htmlentities($vo['ca_id_text']); ?></td>



                <td><?php echo htmlentities($vo['add_time']); ?></td>
                <td><?php echo htmlentities($vo['last_time']); ?>（小时）</td>
                <td class="td-manage">

                    <a style="text-decoration:none" onclick="del(<?php echo htmlentities($vo['id']); ?>,'Last')" title="删除"><i class="Hui-iconfont">&#xe706;</i></a>
                </td>
            </tr>
