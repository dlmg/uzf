<?php /*a:3:{s:60:"D:\phpStudy\WWW\szsc\application\admin\view\qrcode\list.html";i:1532326877;s:61:"D:\phpStudy\WWW\szsc\application\admin\view\public\_meta.html";i:1530329592;s:63:"D:\phpStudy\WWW\szsc\application\admin\view\public\_footer.html";i:1530790557;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	...
	<form class="Huiform" method="get" action="" target="_self">
		...
		<input type="text" class="input-text" style="width:150px" placeholder="二维码编号，代理商姓名，昵称" name="code" value="<?php echo htmlentities((app('request')->get('code') ?: '')); ?>">
...
<script type="text/javascript">
	...
	$('select[name="code"]').val(<?php echo htmlentities(app('request')->get('code')); ?>);
