<?php /*a:3:{s:73:"D:\phpstudy_pro\WWW\127.0.0.3\cjt\application\admin\view\product\add.html";i:1557139425;s:74:"D:\phpstudy_pro\WWW\127.0.0.3\cjt\application\admin\view\public\_meta.html";i:1530329594;s:76:"D:\phpstudy_pro\WWW\127.0.0.3\cjt\application\admin\view\public\_footer.html";i:1530790558;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-article-add">
            ...
            <!-- <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" placeholder="货号" name="pd_code" style="width:20%">
                </div>
            </div> -->
           <!--  <div class="row cl">
            ...
            <div class="row cl">
             ...
             <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text Wdate" name="limitime" id="countTimestart" onfocus="selecttime(1)"  size="17" class="date" readonly style="width:20%"> 
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">主要成分：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" name="constituent"  placeholder="药品主要成分" style="width:20%">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">风格类型：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" name="style_type"  placeholder="风格类型" style="width:20%">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">生产厂家：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" name="manufacturers"  placeholder="生产厂家" style="width:20%">
                </div>
            </div>
            <!-- <div class="row cl">
