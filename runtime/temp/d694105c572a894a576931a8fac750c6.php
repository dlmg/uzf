<?php /*a:3:{s:65:"D:\phpstudy_pro\WWW\uzf\application\admin\view\order\deliver.html";i:1531123730;s:64:"D:\phpstudy_pro\WWW\uzf\application\admin\view\public\_meta.html";i:1530329594;s:66:"D:\phpstudy_pro\WWW\uzf\application\admin\view\public\_footer.html";i:1530790558;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
            ...
            <input type="hidden" name="or_id" value="<?php echo htmlentities($id); ?>" />
             <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" id="" name="or_express" style="width:60%" placeholder="不填请写无">
                </div>
            </div>
            <div class="row cl">
...
<?php endif; ?>
    ...
    function add(){
        $.post("<?php echo url('dodeliver'); ?>", $('form').serialize()).success(function(data) {
            layer.msg(data.msg);
            if (data.code) {
                setTimeout(function() {
