<?php /*a:3:{s:70:"D:\phpstudy_pro\WWW\uzf1\uzf\application\admin\view\product\index.html";i:1586653781;s:69:"D:\phpstudy_pro\WWW\uzf1\uzf\application\admin\view\public\_meta.html";i:1530329594;s:71:"D:\phpstudy_pro\WWW\uzf1\uzf\application\admin\view\public\_footer.html";i:1530790558;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	...
	<!-- 			<option value="6">热门大图</option>
		...
		<input type="text" class="input-text" style="width:150px" placeholder="服务名称" name="pd_name" value="<?php echo htmlentities((app('request')->get('pd_name') ?: '')); ?>">
		...
		<tbody>
			<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<tr class="text-c">
					...
					<!-- <td><input type="text" value="{}" onchange="change(<?php echo htmlentities($vo['id']); ?>,$(this).val(),'')"></td>
					...
					<td><select onchange="change(<?php echo htmlentities($vo['id']); ?>,$(this).val(),'pd_status')">
							<!-- 	<option value="6" <?php if($vo['pd_status'] == 6): ?>selected<?php endif; ?>>热门大图</option>
								...
								<option value="3" <?php if($vo['pd_status'] == 3): ?>selected<?php endif; ?>>热销服务</option> -->
					...
					<?php if($vo['st_status'] == 2): ?>
						<td style="color: green">审核通过</td>
					<?php elseif($vo['st_status'] == 1): ?>
						<td style="color:red">审核中</td>

					<?php endif; ?>

					<td ><a title="竞拍详情" href="javascript:;" onclick="create(<?php echo htmlentities($vo['id']); ?>,'bidding','竞拍详情')" class="ml-5" style="text-decoration:none;color: #902000">竞拍详情</a></td>
