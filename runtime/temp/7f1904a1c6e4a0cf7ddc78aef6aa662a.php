<?php /*a:3:{s:59:"D:\phpStudy\WWW\szsc\application\admin\view\user\index.html";i:1534819345;s:61:"D:\phpStudy\WWW\szsc\application\admin\view\public\_meta.html";i:1530329592;s:63:"D:\phpStudy\WWW\szsc\application\admin\view\public\_footer.html";i:1530790557;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<tbody>
			<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<tr class="text-c">
					...
					<th><?php echo htmlentities($vo['us_level_text']); ?></th>									
					<td><input type="text" value="<?php echo htmlentities($vo['us_shop_bi']); ?>" onchange="change(<?php echo htmlentities($vo['id']); ?>,$(this).val(),'us_shop_bi')"></td>				
					<td class="td-status">
