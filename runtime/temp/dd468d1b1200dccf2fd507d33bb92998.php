<?php /*a:3:{s:70:"D:\phpstudy_pro\WWW\uzf1\uzf\application\admin\view\user\addmoney.html";i:1557195570;s:69:"D:\phpstudy_pro\WWW\uzf1\uzf\application\admin\view\public\_meta.html";i:1530329594;s:71:"D:\phpstudy_pro\WWW\uzf1\uzf\application\admin\view\public\_footer.html";i:1530790558;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<body>
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>会员管理 <span class="c-gray en">&gt;</span> 会员充值 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" >
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
                <?php echo htmlentities($list['us_nickname']); ?>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
               <?php echo htmlentities($list['us_tel']); ?>
            </div>
        </div>
   <!--      <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> 
                <input type="text" name="wa_num" class="input-text" style="width:20%">&nbsp;元
            </div>
        </div>
        <!-- <div class="row cl">
...
function add(){
    $.post('<?php echo url("addmoney"); ?>',$('#form-article-add').serialize()).success(function(data){
    	layer.msg(data.msg);
    	if(data.code){
    		setTimeout(function(){
