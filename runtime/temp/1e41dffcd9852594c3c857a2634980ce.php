<?php /*a:3:{s:61:"D:\phpStudy\WWW\szsc\application\admin\view\product\cate.html";i:1534382985;s:61:"D:\phpStudy\WWW\szsc\application\admin\view\public\_meta.html";i:1530329592;s:63:"D:\phpStudy\WWW\szsc\application\admin\view\public\_footer.html";i:1530790557;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<tbody>
			<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<tr class="text-c">
					...
					<td><img src="<?php echo htmlentities($vo['ca_pic']); ?>" style="width:60px;height:60px" alt=""></td>
					<td class="td-status">
				...
				<?php $_result=getChild($vo['id']);if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i;?>
					<tr class="text-c">
						...
						<td><input type="text" value="<?php echo htmlentities($vo['ca_sort']); ?>" onchange="change(<?php echo htmlentities($voo['id']); ?>,$(this).val(),'ca_sort')" style="width:60px"></td>	
