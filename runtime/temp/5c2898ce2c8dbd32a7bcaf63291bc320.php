<?php /*a:3:{s:68:"D:\phpstudy_pro\WWW\uzf\application\admin\view\product\last_add.html";i:1585792040;s:64:"D:\phpstudy_pro\WWW\uzf\application\admin\view\public\_meta.html";i:1530329594;s:66:"D:\phpstudy_pro\WWW\uzf\application\admin\view\public\_footer.html";i:1530790558;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<article class="page-container">
    <form class="form form-horizontal" id="form-admin-add">
        ...
        <input type="hidden" name="ca_id" value="<?php echo htmlentities($id); ?>" />

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>分类名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <?php echo htmlentities($ca_name); ?>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>时长：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" id="" name="last_time" style="width:20%" >
            </div>
        </div>
        <div class="row cl">
...
<script type="text/javascript">
    ...
    function add(){
        $.post("<?php echo url('last_add'); ?>", $('form').serialize()).success(function(data) {
            layer.msg(data.msg);
            if (data.code) {
                setTimeout(function() {
                    location.href = '';
