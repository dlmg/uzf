<?php /*a:3:{s:74:"D:\phpstudy_pro\WWW\127.0.0.3\cjt\application\admin\view\product\edit.html";i:1557139406;s:74:"D:\phpstudy_pro\WWW\127.0.0.3\cjt\application\admin\view\public\_meta.html";i:1530329594;s:76:"D:\phpstudy_pro\WWW\127.0.0.3\cjt\application\admin\view\public\_footer.html";i:1530790558;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
        ...
        <!--     <div class="row cl">
           ...
           <!--  <div class="row cl">
            ...
            <!-- <div class="row cl">
             ...
             <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">秒杀结束时间：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text Wdate" name="limitime" id="countTimestart" onfocus="selecttime(1)" value="<?php echo htmlentities($info['limitime']); ?>" size="17" class="date" readonly style="width:20%"> 
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">主要成分：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" name="constituent" value="<?php echo htmlentities($info['constituent']); ?>" placeholder="药品主要成分" style="width:20%">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">风格类型：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" name="style_type" value="<?php echo htmlentities($info['style_type']); ?>" placeholder="风格类型" style="width:20%">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">生产厂家：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" name="manufacturers" value="<?php echo htmlentities($info['manufacturers']); ?>" placeholder="生产厂家" style="width:20%">
                </div>
            </div>
            <div class="row cl">
        ...
        var html = 
            '<div class="row cl sku_item">' +
                ...
                '<div class="formControls col-xs-8 col-sm-9">' +
                    '<div class="col-md-3">' +
                        '<div class="formControls col-xs-12 col-sm-12 col-md-9" style="padding: 0">' +
                            '<input type="text" name="sku_list['+i+'][sku_name]" id="" placeholder="商品规格" value="" class="input-text">' +
                        '</div>' +
                    '</div>' +
                    '<div class=" col-md-2">' +
                        '<label class="form-label col-xs-12 col-sm-12 col-md-3" style="text-align: left;padding: 0">价格</label>' +
