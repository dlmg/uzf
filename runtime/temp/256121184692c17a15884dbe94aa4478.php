...
<!--					<li data-node-id="34" class="rule_node"><a data-href="<?php echo url('product/skus'); ?>" data-title="服务规格" href="javascript:void(0)">服务规格</a></li>-->
		...
		<!--投票管理-->
		<dl id="menu-vote">
			<dt data-node-id="50" class="rule_node"><i class="Hui-iconfont">&#xe6cc;</i> 投票管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li data-node-id="51" class="rule_node"><a data-href="<?php echo url('Vote/index'); ?>" data-title="投票列表" href="javascript:void(0)">投票列表</a></li>
				</ul>
				<ul>
					<li data-node-id="52" class="rule_node"><a data-href="<?php echo url('Vote/vote'); ?>" data-title="发起投票" href="javascript:void(0)">发起投票</a></li>
				</ul>
			</dd>
		</dl>
		...
		<!--道具管理-->
		<dl id="menu-tools">
			<dt data-node-id="53" class="rule_node"><i class="Hui-iconfont">&#xe6cc;</i> 道具管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
		...
		<dl id="menu-systems" class="guanli super" >
			...
			<dd>
				<ul>
					...
					<li data-node-id="46" class="rule_node"><a data-href="<?php echo url('setting/award'); ?>" data-title="会员等级设置" href="javascript:void(0)">会员等级设置</a></li>
