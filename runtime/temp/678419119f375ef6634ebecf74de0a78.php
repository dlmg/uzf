<?php /*a:3:{s:60:"E:\phpStudy\WWW\dfsl\application\admin\view\order\index.html";i:1536215498;s:61:"E:\phpStudy\WWW\dfsl\application\admin\view\public\_meta.html";i:1530329592;s:63:"E:\phpStudy\WWW\dfsl\application\admin\view\public\_footer.html";i:1530790557;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<tbody>
			<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<tr class="text-c">
					...
					<td><?php echo htmlentities($vo['status_text']); if($vo['or_status'] == 1): ?><br/><span class="c-red">用户提醒发货次数：<?php echo htmlentities($vo['or_remind_times']); ?></span><?php endif; ?></td>
