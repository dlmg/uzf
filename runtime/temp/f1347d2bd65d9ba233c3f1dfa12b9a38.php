<?php /*a:3:{s:70:"D:\phpstudy_pro\WWW\uzf1\uzf\application\admin\view\setting\index.html";i:1588985041;s:69:"D:\phpstudy_pro\WWW\uzf1\uzf\application\admin\view\public\_meta.html";i:1530329594;s:71:"D:\phpstudy_pro\WWW\uzf1\uzf\application\admin\view\public\_footer.html";i:1530790558;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
			...
			<div class="tabCon">
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						...
						客服电话：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="customer_tel"  value="<?php echo cache('setting')['customer_tel']; ?>" class="input-text" style="width:20%">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						...
						客服微信：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="customer_WeChat"  value="<?php echo cache('setting')['customer_WeChat']; ?>" class="input-text" style="width:20%">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						...
						客服QQ：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="customer_qq"  value="<?php echo cache('setting')['customer_qq']; ?>" class="input-text" style="width:20%">
					</div>
				</div>
				<!-- <div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						...
						当选超级节点所需票数：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="need_votes"  value="<?php echo cache('setting')['need_votes']; ?>" class="input-text" style="width:20%">
					</div>
				</div>
				<!-- <div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
