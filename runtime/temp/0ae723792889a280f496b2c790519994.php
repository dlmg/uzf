<?php /*a:3:{s:70:"D:\phpstudy_pro\WWW\uzf1\uzf\application\admin\view\setting\award.html";i:1587884956;s:69:"D:\phpstudy_pro\WWW\uzf1\uzf\application\admin\view\public\_meta.html";i:1530329594;s:71:"D:\phpstudy_pro\WWW\uzf1\uzf\application\admin\view\public\_footer.html";i:1530790558;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
			...
			<div class="tabCon ">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="num_b_v1"  value="<?php echo cache('setting')['num_b_v1']; ?>" class="input-text" style="width:10%">
					</div>
					<label class="form-label col-xs-4 col-sm-2">
						<span class="c-red">*</span>
						一级会员需要推荐会员的个数：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="num_c_v1"  value="<?php echo cache('setting')['num_c_v1']; ?>" class="input-text" style="width:10%">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						...
						二级会员需要推荐商家的个数：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="num_b_v2"  value="<?php echo cache('setting')['num_b_v2']; ?>" class="input-text" style="width:10%">
					</div>
					<label class="form-label col-xs-4 col-sm-2">
						<span class="c-red">*</span>
						二级会员需要推荐会员的个数：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="num_c_v2"  value="<?php echo cache('setting')['num_c_v2']; ?>" class="input-text" style="width:10%">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						...
						三级会员需要推荐商家的个数：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="num_b_v3"  value="<?php echo cache('setting')['num_b_v3']; ?>" class="input-text" style="width:10%">
					</div>
					<label class="form-label col-xs-4 col-sm-2">
						<span class="c-red">*</span>
						三级会员需要推荐会员的个数：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="num_c_v3"  value="<?php echo cache('setting')['num_c_v3']; ?>" class="input-text" style="width:10%">
					</div>
				</div>
