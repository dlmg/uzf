<?php /*a:3:{s:61:"D:\phpStudy\WWW\dfsl\application\admin\view\agency\index.html";i:1536650896;s:61:"D:\phpStudy\WWW\dfsl\application\admin\view\public\_meta.html";i:1530329594;s:63:"D:\phpStudy\WWW\dfsl\application\admin\view\public\_footer.html";i:1530790558;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<tbody>
			<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<tr class="text-c">
					...
					<td><?php echo htmlentities($vo['us_apply_shopname']); ?></td>
					<td><?php echo htmlentities($vo['us_apply_tel']); ?></td>
					...
					<td class="td-manage">	
						<a href="javascript:;" onclick="change(<?php echo htmlentities($vo['id']); ?>,2,'merchant_status')">[通过]</a>
						<a href="javascript:;" onclick="change2(<?php echo htmlentities($vo['id']); ?>,3,'merchant_status')">[驳回]</a>
					</td>
				</tr>
