<?php /*a:3:{s:58:"D:\phpStudy\WWW\dfsl\application\admin\view\news\edit.html";i:1533806338;s:61:"D:\phpStudy\WWW\dfsl\application\admin\view\public\_meta.html";i:1530329594;s:63:"D:\phpStudy\WWW\dfsl\application\admin\view\public\_footer.html";i:1530790558;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="<?php echo htmlentities($info['title']); ?>" name="title">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>摘要：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="<?php echo htmlentities($info['simple']); ?>" name="simple">
		</div>
	</div>
	<div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <div style="width:110px;height: 110px;position: relative;display: inline-block; ">               
                    <img src="<?php echo htmlentities($info['pic']); ?>" class="logo" style="position: absolute;left: 0;top: 0;width: 100%;height: 100%;">
    ...
    <div style="display:none" class="ttt">
        <input type="text" name="pic" value="<?php echo htmlentities($info['pic']); ?>">
    </div>
	<div class="row cl">
        <label class="form-label col-xs-4 col-sm-2">内容：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <textarea id="editor" type="text/plain" style="width:100%;height:400px;" name="content" ><?php echo $info['content']; ?>
            </textarea>
        </div>
    </div>
	<!-- <div class="row cl">
