<?php /*a:3:{s:59:"E:\phpStudy\WWW\dfsl\application\admin\view\user\index.html";i:1538216758;s:61:"E:\phpStudy\WWW\dfsl\application\admin\view\public\_meta.html";i:1530329594;s:63:"E:\phpStudy\WWW\dfsl\application\admin\view\public\_footer.html";i:1530790558;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
				...
				<tr class="text-c">
					...
					<td>
						<select name="us_level" onchange="change(<?php echo htmlentities($vo['id']); ?>,$(this).val(),'us_level')" >
							<option value="0" <?php if($vo['us_level'] == 0): ?>selected<?php endif; ?>>普通</option>
					...
					<td>
						<?php if($vo['us_abc'] == 1): ?>
						A类
						<?php elseif($vo['us_abc'] == 2): ?>
						B类
						<?php elseif($vo['us_abc'] == 3): ?>
						C类
						<?php else: ?>
						未激活
						<?php endif; ?>
